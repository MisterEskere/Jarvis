...
__all__ = [
    'SPLO_STATIC', 'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SPPS_RESERVED2',
    'SPRULE', 'DISPID_SPPParent', 'eLEXTYPE_PRIVATE5',
    'DISPID_SPEPronunciation', 'SpeechTokenValueCLSID',
    'DISPID_SVAudioOutput', 'SVEPrivate', 'DISPID_SPRText',
    'SDTAlternates', 'SPRECOSTATE', 'DISPID_SRGSetTextSelection',
    'SREPrivate', 'SINone', 'WAVEFORMATEX',
    'SpeechCategoryRecoProfiles', 'SVP_12', 'DISPID_SpeechRecoResult',
    'ISpeechPhoneConverter', 'ISpNotifySink', 'tagSPPROPERTYINFO',
    'ISpeechFileStream', 'SRCS_Disabled', 'SVEVoiceChange',
    'DISPID_SLWType', 'SSFMCreateForWrite', 'DISPID_SRCESoundStart',
    'SPPS_Modifier', 'DISPID_SPISaveToMemory', 'SAFT11kHz8BitStereo',
    'eLEXTYPE_RESERVED7', 'SAFT16kHz16BitStereo',
    'SAFT22kHz16BitStereo', 'DISPID_SPAsItem',
    'DISPID_SOTMatchesAttributes', 'SpeechAudioFormatGUIDText',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SVEStreamStart',
    'DISPID_SVEWord', 'ISpeechVoiceStatus', 'SVP_8',
    'SPTEXTSELECTIONINFO', 'SPWORD', 'SpMMAudioEnum',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SOTCGetDataKey',
    'SDA_Two_Trailing_Spaces', 'SPVPRI_NORMAL', 'SVESentenceBoundary',
    'SVPAlert', 'SPSModifier', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SpeechPhraseReplacement', 'SpeechTokenContext',
    'SAFT16kHz8BitMono', 'SPGS_ENABLED', 'eLEXTYPE_PRIVATE3',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SpeechRegistryUserRoot',
    'SpeechStreamFileMode', 'SGSExclusive', 'SVP_14',
    'SpeechUserTraining', 'SPFM_NUM_MODES',
    'DISPID_SWFEBitsPerSample', 'SpeechTokenKeyFiles',
    'DISPID_SVEStreamEnd', 'DISPID_SRAudioInput', 'eLEXTYPE_PRIVATE8',
    'SAFT44kHz16BitStereo', 'SRSInactive', 'ISpeechAudioBufferInfo',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SGRSAddWordTransition',
    'DISPID_SpeechVoiceStatus', 'SpResourceManager',
    'DISPID_SPPConfidence', 'SPSMF_UPS', 'DISPID_SDKGetStringValue',
    'ISpeechVoice', 'DISPID_SRCEHypothesis', 'SECFIgnoreKanaType',
    'SSFMOpenReadWrite', 'DISPID_SAFType', 'SINoSignal',
    'eLEXTYPE_PRIVATE7', 'DISPID_SPIGetDisplayAttributes',
    'SVSFVoiceMask', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SPRuleConfidence', 'SPAS_CLOSED', 'SRAInterpreter',
    'DISPID_SAStatus', 'DISPID_SASCurrentDevicePosition',
    'SAFT8kHz8BitStereo', 'SPGRAMMARSTATE', 'SpeechEngineProperties',
    'SPINTERFERENCE_TOOFAST', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SDKDeleteKey', 'ISpeechGrammarRuleState',
    'SpeechDataKeyLocation', 'SpeechCategoryAudioIn',
    'ISpeechTextSelectionInformation', 'DISPID_SGRSTText',
    'DISPID_SPARecoResult', 'DISPID_SpeechPhraseAlternates',
    'SSTTTextBuffer', 'SPEI_START_SR_STREAM',
    'SREPropertyStringChange', 'ISpeechPhraseRule',
    'DISPID_SRCEPhraseStart', 'DISPID_SGRsItem', 'SpStream',
    'DISPID_SVEventInterests', 'DISPID_SpeechLexiconWords',
    'ISpeechGrammarRules', 'DISPID_SpeechMemoryStream',
    'DISPID_SGRId', 'DISPID_SMSGetData', 'SAFTGSM610_11kHzMono',
    'SVSFParseSsml', 'DISPID_SpeechVoice', 'DISPID_SRCESoundEnd',
    ...
    'DISPID_SpeechPhraseRules', 'SP_VISEME_21', 'SpeechTokenKeyUI',
    'ISpeechPhraseAlternate', 'DISPID_SLPsCount',
    'DISPID_SCSBaseStream', 'SPXMLRESULTOPTIONS',
    'Speech_Max_Word_Length', 'SRSActiveAlways', 'UINT_PTR',
    'DISPID_SRIsUISupported', 'eLEXTYPE_PRIVATE13',
    'DISPID_SPANumberOfElementsInResult', 'ISpeechDataKey',
    'DISPID_SRCSetAdaptationData', 'SpeechWordType',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SRCRetainedAudio',
    'SpInProcRecoContext', 'SPEI_RESERVED1', 'SDA_One_Trailing_Space',
    'SpeechRuleAttributes', 'SREStateChange',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SRAudioInputStream', '_RemotableHandle', 'SVP_11',
    'DISPID_SVEAudioLevel', 'ISpEventSink', 'DISPID_SRCVoice',
    'SPCT_COMMAND', 'DISPID_SpeechLexiconPronunciation',
    'SPRULESTATE', 'SAFTADPCM_44kHzStereo', 'SPINTERFERENCE_TOOQUIET',
    'SRTStandard', 'SpMMAudioOut', 'DISPID_SAVolume', 'SVSFParseMask',
    'SPRST_INACTIVE', 'SpeechCategoryRecognizers',
    'DISPID_SVSLastBookmarkId', 'DISPID_SPIAudioSizeTime',
    'DISPID_SOTSetId', 'SDTReplacement', 'DISPID_SRCResume',
    'ISpeechCustomStream', 'SPINTERFERENCE_TOOLOUD',
    'SPEI_FALSE_RECOGNITION', 'SPEI_PHONEME', 'SRSEIsSpeaking',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SRGIsPronounceable',
    'DISPID_SVGetAudioOutputs', 'DISPID_SVSLastBookmark',
    'DISPID_SDKDeleteValue', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SREAdaptation', 'SAFT48kHz8BitMono', 'eWORDTYPE_DELETED',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SpeechAudioFormat', 'DISPID_SAFSetWaveFormatEx',
    'SpeechPartOfSpeech', 'DISPID_SpeechAudio',
    'SpeechDisplayAttributes', 'SpeechCategoryVoices',
    'DISPID_SDKCreateKey', 'ISpRecoContext', 'SDKLCurrentUser',
    'DISPID_SRState', 'DISPID_SRGReset', 'SAFTDefault',
    'SREInterference', 'ISpeechPhraseProperties', 'DISPID_SBSSeek',
    'SDTDisplayText', 'SVSFPurgeBeforeSpeak', 'SPWAVEFORMATTYPE',
    'SPPS_NotOverriden', 'SPEVENT', 'SpObjectTokenCategory',
    'SPWF_INPUT', 'DISPID_SVSRunningState', 'ISpMMSysAudio',
    'SPVOICESTATUS', 'SVP_18', 'SPFM_CREATE_ALWAYS',
    'SAFTGSM610_8kHzMono', 'DISPID_SBSRead',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SDKGetlongValue',
    'DISPID_SRGCommit', 'ISpeechRecognizer', 'SINoise',
    'DISPID_SVSpeakStream', 'SPAUDIOSTATUS',
    'SpeechRegistryLocalMachineRoot', 'SPSHORTCUTTYPE',
    'SPBO_TIME_UNITS', 'SVEAllEvents', 'SRTAutopause',
    'DISPID_SLWsCount', 'ISpXMLRecoResult', 'SPEI_SOUND_START',
    'SPRS_INACTIVE', 'DISPID_SPIElements', 'SPLOADOPTIONS', 'SLTUser',
    'SAFTNonStandardFormat', 'SVP_4', 'ISpeechLexicon',
    'ISpPhoneConverter', 'SPSVerb', 'ISpRecognizer2',
    'DISPID_SPIProperties', 'SASStop', 'SITooLoud',
    'SpUnCompressedLexicon', 'DISPID_SPRs_NewEnum', 'DISPID_SRCState',
    'DISPID_SDKEnumKeys', 'SPPS_Function', 'DISPID_SPILanguageId',
    'DISPID_SGRSTPropertyValue', 'DISPID_SPPChildren',
    'SPINTERFERENCE_LATENCY_WARNING', 'SpeechBookmarkOptions',
    'SPWORDLIST', 'SPINTERFERENCE_NONE', 'ISpStreamFormatConverter',
    'SP_VISEME_1', 'DISPID_SVEEnginePrivate', 'DISPID_SRGState',
    'SpSharedRecognizer', 'SpTextSelectionInformation',
    'SGDSActiveWithAutoPause', 'DISPID_SRRTimes', 'STCLocalServer',
    'SpNotifyTranslator', 'SRTExtendableParse', 'DISPID_SGRSTType',
    'SGRSTTTextBuffer', 'DISPID_SDKSetBinaryValue', 'SVP_20',
    'DISPID_SVAudioOutputStream', 'ISpeechPhraseProperty',
    'SP_VISEME_13', 'DISPID_SpeechLexiconWord',
    'DISPID_SPRuleFirstElement', 'ISpPhraseAlt',
    'DISPID_SVSyncronousSpeakTimeout', 'ISpGrammarBuilder', 'SASRun',
    'SAFT32kHz16BitMono', 'SAFT11kHz8BitMono',
    'SWPUnknownWordUnpronounceable', 'eLEXTYPE_PRIVATE16',
    'SAFTCCITT_uLaw_22kHzMono', 'SpeechStreamSeekPositionType',
    'SVEPhoneme', 'SAFTADPCM_11kHzMono', '_SPAUDIOSTATE',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SRRTLength', 'SP_VISEME_14',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SLWPronunciations',
    'SpeechMicTraining', 'SAFT32kHz16BitStereo',
    'DISPID_SVSInputWordPosition', 'DISPID_SRCEAudioLevel',
    'SPRECORESULTTIMES',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'DISPID_SOTCId',
    'SPAO_NONE', 'SAFT22kHz16BitMono', 'ISpeechPhraseInfoBuilder',
    'SAFT44kHz8BitMono', 'DISPID_SRSClsidEngine',
    'DISPID_SGRAddResource', 'DISPID_SPPBRestorePhraseFromMemory',
    'eLEXTYPE_PRIVATE9', 'DISPID_SpeechObjectToken', 'STSF_AppData',
    'DISPID_SPPNumberOfElements', 'ISpeechObjectTokens',
    'DISPID_SGRSRule', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SWFEChannels', 'ISpAudio', 'SGRSTTDictation',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SLPSymbolic',
    'DISPID_SRGId', 'DISPID_SPEDisplayAttributes',
    'SPSHORTCUTPAIRLIST', 'SPSHT_NotOverriden', 'ISpeechRecoGrammar',
    'SpeechRunState', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SpeechPhraseRule', 'SAFTADPCM_22kHzStereo', 'SWTDeleted',
    'SPVPRI_ALERT', 'DISPID_SRGDictationSetState',
    'DISPID_SLGenerationId', 'DISPID_SAEventHandle',
    'SAFTADPCM_11kHzStereo', 'DISPID_SGRInitialState', 'SPFM_CREATE',
    'SPXRO_SML', 'DISPID_SRCCreateResultFromMemory',
    'eLEXTYPE_PRIVATE4', 'DISPID_SWFEExtraData',
    'DISPID_SLPPartOfSpeech', 'SpVoice', 'DISPID_SpeechXMLRecoResult',
    'SGRSTTEpsilon', 'DISPID_SFSOpen', 'DISPID_SOTGetDescription',
    'SPWF_SRENGINE', 'SPGS_EXCLUSIVE', 'SASPause',
    'SPEI_INTERFERENCE', 'SpeechWordPronounceable', 'IStream',
    'STSF_LocalAppData', 'eLEXTYPE_PRIVATE20', 'eLEXTYPE_RESERVED4',
    'ISpPhrase', 'ISpLexicon', 'SpeechGrammarState', 'SP_VISEME_2',
    'SVSFIsXML', 'SAFTExtendedAudioFormat', 'SVP_10',
    'SECFEmulateResult', 'SVF_Stressed', 'SLTApp',
    'DISPID_SRGetPropertyNumber', 'SP_VISEME_18',
    'Speech_StreamPos_RealTime', 'SPEI_TTS_AUDIO_LEVEL',
    'Speech_Max_Pron_Length', 'DISPID_SpeechFileStream',
    'DISPID_SOTsItem', 'SAFTCCITT_uLaw_8kHzMono', 'SECHighConfidence',
    'SpeechLoadOption', 'SPDKL_DefaultLocation', 'SPPS_Verb',
    'SVP_16', 'SPSERIALIZEDPHRASE', 'DISPID_SVPause',
    'SAFTCCITT_ALaw_22kHzStereo', 'SPAUDIOSTATE',
    'DISPID_SVIsUISupported', 'SVPOver', 'ISpNotifySource',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SAFGetWaveFormatEx',
    'DISPID_SpeechDataKey', 'DISPID_SRGRules', 'SVP_17', 'SGDisplay',
    'SRERecognition', 'tagSTATSTG', 'SP_VISEME_17', 'SpMMAudioIn',
    'DISPID_SABIMinNotification', 'DISPID_SVAlertBoundary',
    'ISpObjectToken', 'SpeechAddRemoveWord', 'SPRECOCONTEXTSTATUS',
    'DISPID_SRCEEnginePrivate', 'DISPID_SPEEngineConfidence',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SLRemovePronunciation',
    'DISPID_SRSSupportedLanguages', 'SVP_9', 'ISpObjectTokenCategory',
    'DISPID_SpeechObjectTokens', 'SECLowConfidence',
    'SPSInterjection', 'SPCS_DISABLED', 'tagSPTEXTSELECTIONINFO',
    'SPEI_SOUND_END', 'DISPID_SRGCmdSetRuleState', 'STCInprocHandler',
    'DISPID_SRIsShared', 'DISPID_SRCERecognition', 'SpLexicon',
    'SPEI_MIN_TTS', 'DISPID_SOTCEnumerateTokens', 'DISPID_SOTCSetId',
    'SGSEnabled', 'DISPID_SOTDataKey', 'SPINTERFERENCE',
    'DISPID_SPRulesItem', 'SpeechGrammarRuleStateTransitionType',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SLWs_NewEnum',
    'SpeechSpecialTransitionType', 'DISPID_SPAPhraseInfo',
    'DISPID_SLGetGenerationChange', 'SPEI_RECOGNITION',
    'SpeechPropertyAdaptationOn', 'SP_VISEME_16',
    'DISPID_SRCRecognizer', 'SpAudioFormat',
    'DISPID_SRGetRecognizers', 'DISPID_SpeechCustomStream',
    'DISPID_SOTGetAttribute', 'SPEI_RESERVED6',
    'SpeechGrammarTagDictation', 'SpeechCategoryPhoneConverters',
    'SVP_3', 'SPPARTOFSPEECH', 'eLEXTYPE_RESERVED8',
    'DISPID_SRSetPropertyNumber', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'ISpeechAudioFormat', 'SP_VISEME_8', 'ISpeechRecoResultTimes',
    'DISPID_SPIGrammarId', 'eLEXTYPE_LETTERTOSOUND',
    'SPCT_SUB_DICTATION', 'SAFT24kHz8BitMono', 'DISPID_SPACommit',
    'SpeechAudioState', 'ISpRecoGrammar2', 'SPEVENTSOURCEINFO',
    'SDA_Consume_Leading_Spaces', 'SPFM_OPEN_READONLY',
    'SPXRO_Alternates_SML', 'SAFT24kHz8BitStereo',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SVSLastResult',
    'DISPID_SVSInputWordLength', 'ISpeechWaveFormatEx', 'SRSEDone',
    'DISPID_SRCEEndStream', 'DISPID_SRCEBookmark', 'SDTAll',
    'SpMemoryStream', 'ISpeechLexiconPronunciations',
    'ISpPhoneticAlphabetSelection', 'SPSEMANTICERRORINFO',
    'SDKLCurrentConfig', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SPRulesCount', 'SPEI_END_INPUT_STREAM', 'SPSNotOverriden',
    'SPINTERFERENCE_NOISE', 'SpeechAudioProperties',
    'IEnumSpObjectTokens', 'SpObjectToken', 'DISPID_SPELexicalForm',
    'SPWORDTYPE', 'DISPID_SPAsCount', 'SPGS_DISABLED',
    'DISPID_SPRuleId', 'SPLEXICONTYPE', 'SPEI_TTS_BOOKMARK',
    'ISpeechObjectToken', 'DISPID_SMSAMMHandle', 'SVSFIsFilename',
    'SGRSTTRule', 'SpSharedRecoContext', 'SRERequestUI',
    'SPPS_SuppressWord', 'Speech_Default_Weight',
    'DISPID_SpeechGrammarRules', 'DISPID_SLPLangId',
    'eLEXTYPE_PRIVATE12', 'DISPID_SpeechAudioBufferInfo',
    'SPPHRASEPROPERTY', 'DISPID_SPRsItem', 'SPAS_STOP',
    'DISPID_SGRSTPropertyName', 'SVSFPersistXML',
    'ISpeechPhraseElements', 'DISPID_SpeechLexicon',
    ...
    'SAFT22kHz8BitMono', 'SP_VISEME_12', 'eLEXTYPE_USER',
    'SREStreamStart', 'SpeechVisemeFeature',
    'DISPID_SRSCurrentStreamNumber', 'ISpSerializeState',
    'DISPIDSPTSI', 'SPCT_DICTATION', 'DISPID_SVEViseme',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SPPS_Noncontent',
    'SpeechRuleState', 'SpeechAudioFormatGUIDWave',
    'DISPID_SRCEAdaptation', 'SpeechFormatType', 'SPAR_Low',
    'SPFM_OPEN_READWRITE', 'SREPhraseStart', 'SSFMCreate',
    'SpeechVoicePriority', 'SPSMF_SRGS_SAPIPROPERTIES', 'LONG_PTR',
    'DISPID_SRRDiscardResultInfo', 'SAFT48kHz8BitStereo',
    'SPPS_RESERVED4', 'SP_VISEME_9', 'SPSERIALIZEDRESULT',
    'SAFT12kHz16BitStereo', 'SDKLDefaultLocation', 'SLODynamic',
    'SAFT44kHz8BitStereo', 'SPPROPERTYINFO', 'SVP_19',
    'DISPID_SVStatus', 'DISPID_SVDisplayUI', 'DISPID_SRStatus',
    'DISPID_SPAs_NewEnum', 'SPEI_UNDEFINED', 'DISPID_SOTRemove',
    'ISpeechRecoResultDispatch', 'SSTTDictation', 'DISPID_SGRsCommit',
    'SPSUnknown', 'SpeechGrammarTagUnlimitedDictation',
    'SpNullPhoneConverter', 'DISPID_SGRSTsCount',
    'DISPID_SRRSetTextFeedback', 'DISPID_SWFESamplesPerSec',
    'DISPID_SLPs_NewEnum', 'SPSSuppressWord', 'SPRECOGNIZERSTATUS',
    'ISpPhoneticAlphabetConverter', 'SPAUDIOOPTIONS',
    'ISpResourceManager', 'DISPID_SOTDisplayUI',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SPIReplacements',
    'SPDKL_CurrentUser', 'SAFTNoAssignedFormat', 'SPCT_SLEEP',
    'eLEXTYPE_PRIVATE14', 'IInternetSecurityManager',
    'SAFT24kHz16BitStereo', 'SBOPause', 'DISPID_SVEVoiceChange',
    'DISPID_SVVoice', 'DISPID_SRGCmdSetRuleIdState',
    'SPDATAKEYLOCATION', 'SRAExport', 'SPAO_RETAIN_AUDIO',
    'SRERecoOtherContext', 'ISpeechObjectTokenCategory',
    'SGRSTTWildcard', 'SAFTCCITT_ALaw_8kHzMono', 'SECFDefault',
    'SRSActive', 'ISpeechRecoContext', 'SPPS_LMA', 'SPAS_PAUSE',
    'SpeechAllElements', 'SP_VISEME_5', 'ISpStream', 'SVP_21',
    ...
    'ISpRecoContext2', 'SAFT24kHz16BitMono', 'DISPID_SRCPause',
    'SPPS_Unknown', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SRRTOffsetFromStart', 'ISpProperties',
    'SAFTADPCM_8kHzStereo', 'SRESoundStart', 'STSF_CommonAppData',
    'DISPID_SRGDictationUnload',
    'DISPID_SRCERecognitionForOtherContext', 'DISPID_SGRAttributes',
    'SPBOOKMARKOPTIONS', 'SVP_0', 'DISPID_SPIRule',
    'ISpeechXMLRecoResult', 'SGSDisabled', 'SpeechInterference',
    '_ISpeechRecoContextEvents', 'DISPID_SPRNumberOfElements',
    'DISPID_SPPs_NewEnum', 'SSSPTRelativeToStart',
    'DISPID_SABufferNotifySize', 'DISPID_SPEs_NewEnum', 'SRATopLevel',
    'SGPronounciation', 'DISPID_SLPsItem',
    ...
    'SAFTCCITT_uLaw_8kHzStereo', 'SPEI_MAX_SR',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SABIBufferSize', 'SLOStatic',
    'DISPID_SRCRetainedAudioFormat', 'SP_VISEME_11',
    'ISpeechMemoryStream', 'SpeechLexiconType', 'DISPID_SMSALineId',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SGLexicalNoSpecialChars', 'SREStreamEnd',
    'DISPID_SDKSetStringValue', 'eLEXTYPE_PRIVATE17',
    'eLEXTYPE_PRIVATE15', 'SPCS_ENABLED', 'DISPID_SRCEventInterests',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SMSADeviceId',
    'DISPID_SPRules_NewEnum', 'DISPID_SWFEBlockAlign',
    'ISpRecognizer3', 'DISPID_SABufferInfo', 'SPPHRASERULE',
    'DISPID_SRCBookmark', 'ISpeechGrammarRuleStateTransition',
    ...
    'DISPID_SRRGetXMLResult', 'DISPID_SDKGetBinaryValue',
    'SPFILEMODE', 'SPEI_RECO_STATE_CHANGE', 'DISPID_SPPsCount',
    'SpeechRecognizerState', 'DISPID_SpeechPhraseInfo', 'SRTEmulated',
    'SP_VISEME_20', 'SRAONone', 'SITooQuiet',
    ...
    'DISPID_SOTs_NewEnum', 'DISPID_SLWLangId', 'SFTSREngine',
    ...
    'DISPID_SPRuleName', 'SPAR_High', 'DISPID_SVEBookmark',
    'ISpeechPhraseAlternates', 'DISPID_SRGetPropertyString',
    'eLEXTYPE_PRIVATE11', 'DISPIDSPTSI_SelectionOffset',
    'ISpRecognizer', 'DISPID_SPAStartElementInResult',
    'ISpRecoResult', 'SPPHRASEREPLACEMENT',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SpeechGrammarRuleState', 'SpeechVoiceSpeakFlags',
    'DISPID_SVSPhonemeId', 'DISPID_SRRPhraseInfo',
    'DISPID_SPRFirstElement', 'SPPHRASE', 'SpeechAudioVolume',
    'SPEI_TTS_PRIVATE', 'DISPID_SAFGuid', 'SVSFNLPSpeakPunc',
    'SPVISEMES', 'SVEAudioLevel', 'DISPID_SpeechPhraseProperty',
    'DISPID_SRRAudioFormat', 'SP_VISEME_6', 'DISPID_SGRClear',
    'SpeechDiscardType', 'ISpDataKey', 'DISPID_SRRAudio',
    'SPEI_VOICE_CHANGE', 'SPEI_PROPERTY_STRING_CHANGE',
    'SAFT12kHz8BitStereo', 'DISPID_SVSpeak', 'SPPS_Interjection',
    'DISPID_SRGRecoContext', 'STCAll', 'SPGRAMMARWORDTYPE', 'SVP_2',
    'DISPID_SpeechBaseStream', 'DISPID_SPIEngineId', 'SGDSInactive',
    'DISPID_SpeechMMSysAudio', 'SAFTGSM610_22kHzMono',
    'DISPID_SRCCmdMaxAlternates', 'SPEI_RESERVED5', 'SPPS_Noun',
    'DISPID_SPEDisplayText', 'SAFTADPCM_8kHzMono', 'SP_VISEME_4',
    'DISPID_SPEActualConfidence', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SRGCmdLoadFromFile', 'SpCompressedLexicon',
    'SVSFIsNotXML', 'SPEI_VISEME', 'SVEEndInputStream',
    'DISPID_SRCEPropertyStringChange', 'SPRST_ACTIVE',
    'SpeechGrammarTagWildcard', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SPEsItem', 'SPPS_RESERVED1', 'SpCustomStream',
    'ISpStreamFormat', 'DISPID_SMSSetData', 'SP_VISEME_19',
    'DISPID_SVGetVoices', 'SPEI_END_SR_STREAM',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SPPName',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SGRsDynamic',
    'DISPID_SABIEventBias', 'eLEXTYPE_APP', 'DISPID_SRRRecoContext',
    'eLEXTYPE_PRIVATE2', 'SAFT11kHz16BitStereo', 'SPWT_PRONUNCIATION',
    'DISPID_SDKOpenKey', 'SP_VISEME_3', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SRRTTickCount', 'SPVPRIORITY',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SVPNormal', 'SAFTText',
    'SPBO_NONE', 'SGRSTTWord', 'ISpeechPhraseReplacements',
    'SpeechPropertyResponseSpeed', 'SPEI_START_INPUT_STREAM',
    'DISPID_SpeechRecognizer', 'ISequentialStream', 'DISPID_SPPId',
    'SPSHT_OTHER', 'eLEXTYPE_MORPHOLOGY', 'eLEXTYPE_RESERVED6',
    'ISpeechLexiconPronunciation', 'DISPID_SRRSpeakAudio',
    'DISPIDSPRG', 'DISPID_SPIAudioStreamPosition',
    'ISpeechGrammarRule', 'SVEBookmark',
    'DISPID_SRCAudioInInterferenceStatus', 'SpFileStream',
    'SPEI_REQUEST_UI', 'SPEI_RECO_OTHER_CONTEXT',
    'SAFT48kHz16BitStereo', 'DISPID_SGRSTRule', 'DISPID_SGRAddState',
    'SpeechPropertyLowConfidenceThreshold', 'SSSPTRelativeToEnd',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SPPValue',
    'SpInprocRecognizer', 'DISPID_SGRsCount', 'DISPID_SDKEnumValues',
    'DISPID_SPIGetText', 'DISPID_SPIStartTime', 'SPSHORTCUTPAIR',
    'SGDSActiveUserDelimited', 'DISPID_SPCPhoneToId', 'SWTAdded',
    'SVSFNLPMask', 'SAFTCCITT_ALaw_8kHzStereo',
    'SpeechEmulationCompareFlags', 'DISPID_SPCIdToPhone',
    'SPEI_HYPOTHESIS', 'SpeechRecognitionType', 'SPAS_RUN',
    'DISPID_SPRuleChildren', 'SRAImport', 'DISPID_SVWaitUntilDone',
    'eLEXTYPE_PRIVATE19', 'SPEI_MAX_TTS', 'STCInprocServer',
    'SPLO_DYNAMIC', 'DISPID_SpeechAudioStatus',
    'DISPID_SPEAudioSizeTime', 'ISpeechPhraseRules',
    'DISPID_SVPriority', 'DISPID_SOTCategory', 'SPPS_RESERVED3',
    'ISpeechLexiconWords', 'DISPID_SREmulateRecognition',
    'SPEI_SR_AUDIO_LEVEL', 'eLEXTYPE_PRIVATE6', 'DISPID_SLWsItem',
    'SP_VISEME_10', 'Speech_StreamPos_Asap', 'SREBookmark',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SRCEStartStream',
    'SRCS_Enabled', 'DISPID_SASetState', 'SFTInput',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SpeechTokenShellFolder', 'SP_VISEME_15',
    ...
    'ISpNotifyTranslator', 'SAFT44kHz16BitMono', 'DISPID_SOTCDefault',
    'SPRS_ACTIVE', 'DISPID_SRGetFormat', 'SRTReSent', 'ISpeechAudio',
    'SPBO_AHEAD', 'DISPID_SOTRemoveStorageFileName',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SpeechPhraseElements',
    'SVF_Emphasis', 'SVP_15', 'DISPID_SLAddPronunciation',
    'DISPID_SVGetProfiles', 'SpShortcut', 'SpeechGrammarWordType',
    'SPAR_Unknown', 'SREAllEvents', 'SVSFParseSapi',
    'DISPID_SRProfile', 'DISPID_SPEsCount', 'SREFalseRecognition',
    'DISPID_SVSInputSentenceLength', 'SAFT16kHz16BitMono',
    'DISPID_SVEPhoneme', 'DISPID_SVResume', 'SPWT_LEXICAL',
    'DISPID_SpeechRecoContextEvents', 'SAFT8kHz16BitStereo',
    'SVEWordBoundary', 'DISPID_SRRAlternates', 'SVEViseme', 'SPSLMA',
    'SPSTREAMFORMATTYPE', 'DISPID_SVSkip', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SRCEFalseRecognition', 'SECFNoSpecialChars',
    'DISPID_SPRsCount', 'SpeechRecoContextState',
    'DISPID_SRCERequestUI', 'DISPID_SGRSTransitions',
    'SAFT12kHz16BitMono', 'SAFT8kHz8BitMono',
    'SPINTERFERENCE_TOOSLOW', 'SVP_7', 'SPSHT_Unknown',
    'DISPID_SpeechPhraseAlternate', 'IEnumString',
    'SPDKL_LocalMachine', 'ISpeechGrammarRuleStateTransitions',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'ISpeechRecoResult',
    'DISPID_SRRTStreamTime', 'DISPID_SLGetPronunciations',
    'SAFTCCITT_ALaw_11kHzStereo', 'SPEI_RESERVED2', 'SPBO_PAUSE',
    'SDKLLocalMachine', 'SPCATEGORYTYPE', 'SpeechCategoryAudioOut',
    'SPWT_DISPLAY', 'SREHypothesis', 'SVP_13', 'SRARoot',
    'SPADAPTATIONRELEVANCE', 'SVSFUnusedFlags', 'ISpRecoGrammar',
    'SSTTWildcard', 'SpeechTokenIdUserLexicon', 'SRAORetainAudio',
    'SRTSMLTimeout', 'DISPID_SOTIsUISupported',
    'ISpeechRecognizerStatus', 'DISPID_SRRSaveToMemory',
    'SPEI_SR_BOOKMARK', 'SAFTCCITT_ALaw_44kHzMono',
    'DISPID_SpeechRecoResultTimes', 'eWORDTYPE_ADDED',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SPRuleParent',
    'SPCONTEXTSTATE', 'DISPID_SLPPhoneIds',
    'SpeechPropertyNormalConfidenceThreshold', 'DISPID_SLWWord',
    'ISpRecoCategory', 'DISPID_SPPFirstElement',
    'DISPID_SRRGetXMLErrorInfo', 'ISpeechRecoResult2',
    'SpeechTokenKeyAttributes', 'DISPID_SRDisplayUI',
    'SDTPronunciation', 'SPAUDIOBUFFERINFO', 'SpWaveFormatEx',
    'SDA_No_Trailing_Space', 'SBONone', 'DISPID_SpeechGrammarRule',
    'SpeechVisemeType', 'eLEXTYPE_PRIVATE18', 'SVF_None',
    'DISPID_SPPsItem', 'STSF_FlagCreate', 'SRESoundEnd',
    'SpPhoneticAlphabetConverter', 'SPEI_SR_PRIVATE',
    'eLEXTYPE_PRIVATE10', 'DISPID_SBSWrite',
    'SAFTTrueSpeech_8kHz1BitMono', 'SREAudioLevel', 'SVP_1',
    'SpeechDictationTopicSpelling', 'DISPID_SpeechRecoResult2',
    'SPWORDPRONUNCIATION', 'SAFT48kHz16BitMono', 'DISPID_SFSClose',
    'DISPID_SpeechPhraseReplacements', 'SpPhraseInfoBuilder',
    'SPEI_MIN_SR', 'DISPID_SGRsAdd', 'DISPID_SBSFormat',
    'DISPID_SVSVisemeId', 'SPPHRASEELEMENT', 'SDTProperty',
    'SP_VISEME_7', 'DISPID_SRRecognizer', 'DISPID_SGRsFindRule',
    'SpeechEngineConfidence', 'DISPID_SpeechRecognizerStatus',
    'eLEXTYPE_PRIVATE1', 'SpPhoneConverter',
    'DISPID_SRGCmdLoadFromMemory', 'ISpeechBaseStream',
    'DISPID_SLPType', 'DISPID_SPRDisplayAttributes',
    'SAFT32kHz8BitStereo', '__MIDL_IWinTypes_0009', 'ISpShortcut',
    'ISpeechLexiconWord', 'DISPID_SOTId',
    'SpeechVoiceCategoryTTSRate', 'IInternetSecurityMgrSite',
    'DISPID_SpeechWaveFormatEx', 'SGLexical', 'SPDKL_CurrentConfig',
    'SPEI_PROPERTY_NUM_CHANGE', 'SRSInactiveWithPurge',
    '_ISpeechVoiceEvents', 'SAFTGSM610_44kHzMono',
    'DISPID_SpeechLexiconProns', 'SRADefaultToActive',
    'SpeechRetainedAudioOptions', 'SPVPRI_OVER',
    'SAFT16kHz8BitStereo', 'ISpEventSource', 'ISpeechPhraseInfo',
    'DISPID_SLGetWords', 'DISPID_SRSAudioStatus', 'SVP_5',
    'STCRemoteServer', 'SPAR_Medium', 'SWPKnownWordPronounceable',
    'DISPID_SWFEAvgBytesPerSec', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SGRsCommitAndSave', 'SITooSlow',
    'DISPID_SRGCmdLoadFromResource', 'SVEStartInputStream',
    'ISpeechPhraseReplacement', 'DISPID_SGRs_NewEnum',
    'SPEI_SENTENCE_BOUNDARY', 'SAFTCCITT_uLaw_44kHzMono', 'ISpVoice',
    'DISPID_SPERequiredConfidence', 'DISPID_SGRSTWeight', 'SITooFast',
    'SP_VISEME_0', 'eLEXTYPE_VENDORLEXICON', 'SASClosed',
    'SpeechRecoEvents', 'SECFIgnoreWidth', 'SGDSActive',
    'SPEI_RESERVED3', 'DISPID_SGRSTPropertyId', 'SRADynamic',
    'SPSHT_EMAIL', 'DISPID_SASNonBlockingIO', 'DISPID_SPCLangId',
    'DISPID_SASState', 'DISPID_SRGDictationLoad',
    'DISPID_SLAddPronunciationByPhoneIds', 'SDTRule', 'SVP_6',
    'DISPID_SWFEFormatTag', 'SDTAudio',
    'DISPID_SOTGetStorageFileName', 'ISpeechMMSysAudio',
    'DISPID_SPRuleNumberOfElements', 'SpeechRecoProfileProperties',
    'SPEVENTENUM', 'SAFT8kHz16BitMono', 'DISPID_SASFreeBufferSpace',
    'DISPID_SVGetAudioInputs',
    'SpeechPropertyHighConfidenceThreshold', 'DISPID_SADefaultFormat',
    'SPSNoun', 'SDTLexicalForm', 'DISPID_SRCEInterference',
    'SPWORDPRONOUNCEABLE', 'DISPID_SRCreateRecoContext',
    'SECNormalConfidence', 'SPSFunction', 'SPRST_NUM_STATES',
    'SVSFDefault', 'SAFT32kHz8BitMono', 'eLEXTYPE_RESERVED9',
    'DISPID_SpeechPhraseElement', 'SPEI_PHRASE_START',
    'SPCT_SUB_COMMAND', 'SREPropertyNumChange',
    'DISPID_SGRSTNextState', 'SPBINARYGRAMMAR', 'DISPID_SGRName',
    'SAFT11kHz16BitMono', 'DISPID_SpeechPhraseProperties',
    'SVSFlagsAsync', 'DISPID_SRGCmdLoadFromObject',
